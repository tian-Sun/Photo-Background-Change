        ...
        <div className="flex flex-col gap-4">
          ...
          <Card className="p-4 aspect-[4/3]">
            <div className="h-full flex flex-col">
              <Label className="text-base font-semibold mb-3">上传图片</Label>
          ...
          <Card className="p-4">
            <div className="space-y-3">
              <Label className="text-base font-semibold">选择样式</Label>
              <StyleSelector
                value={selectedStyle}
          ...
          <Card className="p-4">
            <div className="space-y-3">
              <Label className="text-base font-semibold">比例选择</Label>
              <AspectRatioSelector
                value={selectedRatio}
          ...
          <Button 
            ...
            size="lg"
          >
            {generationStatus === 'generating' ? '生成中...' : '生成按钮'}
          </Button>
